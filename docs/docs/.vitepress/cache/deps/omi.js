...
!function() {
  if ("undefined" != typeof document && !("adoptedStyleSheets" in document)) {
    ...
    var p3 = { childList: true, subtree: true }, d3 = /* @__PURE__ */ new WeakMap(), h3 = /* @__PURE__ */ new WeakMap(), v2 = /* @__PURE__ */ new WeakMap(), y2 = /* @__PURE__ */ new WeakMap(), m2 = _2.prototype;
    if (m2.isConnected = function() {
      ...
      var e3 = R2(this);
      y2.get(this).observe(e3, p3), v2.get(this).length > 0 && x2(this), T2(e3, function(e4) {
        k2(e4).connect();
      });
      ...
      }), v2.set(t3, s4), t3.isConnected() && s4.length > 0 && x2(t3);
    }, window.CSSStyleSheet = j2, N2(Document), "ShadowRoot" in window) {
      N2(ShadowRoot);
      var b3 = Element.prototype, g2 = b3.attachShadow;
      b3.attachShadow = function(e3) {
        var t3 = g2.call(this, e3);
  ...
  function k2(e3) {
    var t3 = d3.get(e3);
    return t3 || (t3 = new _2(e3), d3.set(e3, t3)), t3;
  }
  function N2(e3) {
  ...
  function x2(e3) {
    var t3 = document.createDocumentFragment(), n4 = v2.get(e3), r4 = y2.get(e3), o4 = R2(e3);
    ...
    n4.sheets = [], h3.set(n4, t3), v2.set(n4, []), y2.set(n4, new MutationObserver(function(t4, r4) {
      document ? t4.forEach(function(t5) {
        e2 || i3.call(t5.addedNodes, function(e3) {
          e3 instanceof Element && T2(e3, function(e4) {
            k2(e4).connect();
          });
          ...
          }(n4, t6) && x2(n4), e2 || T2(t6, function(e3) {
            k2(e3).disconnect();
          }));
        });
      }) : r4.disconnect();
...
function P(e2) {
  return Array.from(e2).map(function(e3) {
    if (e3.nodeType === Node.TEXT_NODE) return e3.textContent || "";
    var t2 = e3;
    if (t2.nodeType === Node.ELEMENT_NODE) {
      var n3 = { ignoreAttrs: false };
      Array.from(t2.attributes).forEach(function(e4) {
        n3[f2(e4.name)] = e4.value;
      });
      var r3 = P(t2.childNodes);
      return { nodeName: t2.tagName.toLowerCase(), attributes: n3, children: r3, key: n3.key };
    }
    return null;
  }).filter(Boolean);
}
function A(e2, t2) {
  var n3;
  if (t2 ? "boolean" != typeof t2.ignoreAttrs && (t2.ignoreAttrs = true) : t2 = { ignoreAttrs: true }, arguments.length > 2 ? n3 = [].slice.call(arguments, 2).flat() : null != t2.children && (n3 = t2.children, delete t2.children), e2 === p2) return n3;
...
function j(e2, t2) {
  ...
  return A(e2.nodeName, o2({}, e2.attributes, t2), n3.length > 0 ? n3.flat() : e2.children);
}
...
var k = { onanimationcancel: 1, oncompositionend: 1, oncompositionstart: 1, oncompositionupdate: 1, onfocusin: 1, onfocusout: 1, onscrollend: 1, ontouchcancel: 1, ontouchend: 1, ontouchmove: 1, ontouchstart: 1 };
...
function _(e2, t2, n3, r3, o3) {
  if ("className" === t2 && (t2 = "class"), "o" == t2[0] && "-" == t2[1] && Promise.resolve().then(function() {
    ...
    if ("string" == typeof n3 && (e2.style.cssText = n3 = ""), n3) for (t2 in n3) r3 && t2 in r3 || L(e2.style, t2, "");
    if (r3) for (t2 in r3) n3 && r3[t2] === n3[t2] || L(e2.style, t2, r3[t2]);
  }
    ...
    t3 = (k[i4] || i4 in e3 ? i4 : t3).slice(2), n4 ? r4 || e3.addEventListener(t3, M, o4) : e3.removeEventListener(t3, M, o4), (e3._listeners || (e3._listeners = {}))[t3] = n4;
  }(e2, t2, r3, n3);
...
function L(e2, t2, n3) {
  "-" === t2[0] ? e2.setProperty(t2, null == n3 ? "" : n3.toString()) : e2[t2] = null == n3 ? "" : "number" != typeof n3 || N.test(t2) ? n3.toString() : n3 + "px";
}
var F = 0;
var D = false;
var I = false;
var V = false;
function H(e2, t2, n3, r3, o3) {
  return e2 || t2 ? (r3 && r3.constructor.isLightDOM && (r3.innerHTML = ""), F++ || (D = null != n3 && void 0 !== n3.ownerSVGElement, V = false), h2(t2) ? n3 ? (W(n3, t2, V, r3, o3), i3 = n3.childNodes) : (i3 = [], t2.forEach(function(t3, n4) {
    var s4 = U(0 === n4 ? e2 : null, t3, r3, o3);
    i3.push(s4);
  })) : (h2(e2) || e2 instanceof NodeList ? [].concat(e2).forEach(function(e3, n4) {
    0 === n4 ? i3 = U(e3, t2, r3, o3) : q(e3, false);
  }) : i3 = U(e2, t2, r3, o3), n3 && (null == (s3 = i3) ? void 0 : s3.parentNode) !== n3 && n3.appendChild(i3)), --F || (V = false), i3) : null;
  var i3, s3;
}
function U(e2, t2, n3, r3) {
  e2 && t2 && e2.props && (e2.props.children = t2.children);
  var o3, i3 = e2, s3 = D, a3 = I;
  if (null != t2 && "boolean" != typeof t2 || (t2 = ""), "string" == typeof t2 || "number" == typeof t2) return e2 && void 0 !== e2.splitText && e2.parentNode && (!e2._component || n3) ? e2.nodeValue != t2 && (e2.nodeValue = String(t2)) : (i3 = document.createTextNode(String(t2)), e2 && (e2.parentNode && (null == (o3 = e2.parentNode) || o3.replaceChild(i3, e2)), q(e2, true))), i3 && (i3.prevProps = {}), i3;
  var c3, u3, l2, p3 = t2.nodeName;
  if (I = "foreignObject" === p3, D = "svg" === p3 || !I && D, p3 = String(p3), (!e2 || !b2(e2, p3)) && (u3 = p3, (l2 = I || D ? document.createElementNS("http://www.w3.org/2000/svg", u3) : document.createElement(u3)).normalizedNodeName = u3, "Component" === (null == (c3 = (i3 = l2).constructor) ? void 0 : c3.is) && Object.assign(i3.props, t2.attributes), e2)) {
    for (var d3; e2.firstChild; ) i3.appendChild(e2.firstChild);
    e2.parentNode && (null == (d3 = e2.parentNode) || d3.replaceChild(i3, e2)), q(e2, true);
  }
  var h3 = i3.firstChild, v2 = i3.prevProps, y2 = t2.children;
  if (null == v2) {
    v2 = i3.prevProps = {};
    for (var m2 = i3.attributes, g2 = m2.length; g2--; ) v2[m2[g2].name] = m2[g2].value;
  }
  return !V && y2 && 1 === y2.length && "string" == typeof y2[0] && null != h3 && void 0 !== h3.splitText && null == h3.nextSibling ? h3.nodeValue != y2[0] && (h3.nodeValue = y2[0]) : (y2 && y2.length || null != h3) && ("Component" == i3.constructor.is && i3.constructor.noSlot || W(i3, y2, V || null != v2.unsafeHTML, n3, r3)), function(e3, t3, n4, r4, o4) {
    var i4, s4, a4 = e3.update;
    for (i4 in e3.receiveProps && (s4 = Object.assign({}, n4)), n4) t3 && null != t3[i4] || null == n4[i4] || (_(e3, i4, n4[i4], n4[i4] = void 0, I || D), a4 && delete e3.props[i4]);
    for (i4 in t3) if (a4 && "object" == typeof t3[i4] && "ref" !== i4) {
      ("style" === i4 || "o" === i4[0] && "-" === i4[1]) && _(e3, i4, n4[i4], n4[i4] = t3[i4], I || D);
      var c4 = f2(i4);
      e3.props[c4] = n4[c4] = t3[i4];
    } else if ("children" !== i4 && (!(i4 in n4) || t3[i4] !== ("value" === i4 || "checked" === i4 ? e3[i4] : n4[i4]))) if (_(e3, i4, n4[i4], t3[i4], I || D), -1 !== e3.nodeName.indexOf("-")) {
      e3.props = e3.props || {};
      var u4 = f2(i4);
      e3.props[u4] = n4[u4] = t3[i4];
    } else n4[i4] = t3[i4];
    a4 && !o4 && e3.parentNode && false !== (null == e3 || null == e3.receiveProps ? void 0 : e3.receiveProps(e3.props, s4)) && (null == e3 || null == e3.queuedUpdate || e3.queuedUpdate());
  }(i3, t2.attributes, v2, 0, r3), i3.props && (i3.props.children = t2.children), D = s3, I = a3, i3;
}
function W(e2, t2, n3, r3, o3) {
  var i3, s3, a3, c3, u3, l2, f3, p3 = e2.childNodes, d3 = [], h3 = {}, v2 = 0, y2 = 0, m2 = p3.length, g2 = 0, S2 = t2 ? t2.length : 0;
  if (0 !== m2) for (var w2 = 0; w2 < m2; w2++) {
    var E2, C2 = p3[w2], O2 = C2.prevProps, P2 = S2 && O2 ? O2.key : null;
    null != P2 ? (v2++, h3[P2] = C2) : (O2 || (void 0 !== C2.splitText ? !n3 || (null == (E2 = C2.nodeValue) ? void 0 : E2.trim()) : n3)) && (d3[g2++] = C2);
  }
  if (0 !== S2) for (var A2 = 0; A2 < S2; A2++) {
    if (u3 = null, c3 = t2[A2]) {
      ...
      if (null != j2) v2 && void 0 !== h3[j2] && (u3 = h3[j2], h3[j2] = void 0, v2--);
        ...
        for (i3 = y2; i3 < g2; i3++) if (void 0 !== d3[i3] && (l2 = s3 = d3[i3], "string" == typeof (f3 = c3) || "number" == typeof f3 ? void 0 !== l2.splitText : b2(l2, f3.nodeName))) {
          u3 = s3, d3[i3] = void 0, i3 === g2 - 1 && g2--, i3 === y2 && y2++;
          break;
        }
      }
    }
    u3 = U(u3, c3, r3, o3), a3 = p3[A2], u3 && u3 !== e2 && u3 !== a3 && (null == a3 ? e2.appendChild(u3) : u3 === a3.nextSibling ? x(a3) : e2.insertBefore(u3, a3));
  }
  if (v2) for (var k2 in h3) void 0 !== h3[k2] && q(h3[k2], false);
  for (; y2 <= g2; ) void 0 !== (u3 = d3[g2--]) && q(u3, false);
}
function q(e2, t2) {
  null != e2.prevProps && e2.prevProps.ref && ("function" == typeof e2.prevProps.ref ? e2.prevProps.ref(null) : e2.prevProps.ref.current && (e2.prevProps.ref.current = null)), false !== t2 && null != e2.prevProps || x(e2), function(e3) {
    var t3;
...
var B = { mixin: {}, globalCSS: [] };
function $(e2) {
  Object.assign(B.mixin, e2);
}
function J(e2) {
  B.globalCSS.includes(e2) || B.globalCSS.push(e2);
}
var Q = { define: function(e2) {
...
function G(e2, t2) {
  ...
  return function(t3) {
    n3 && (n3 && (O(t3, Q), t3.formAssociated = true), function(e3, t4) {
...
var ee = function(n3) {
  ...
  return u3.executeHooks = function(e2) {
    ...
    this.props = Object.assign({}, this.constructor.defaultProps, this.props), this.props.ignoreAttrs || this.handleComplexProps();
  }, u3.handleComplexProps = function() {
    var e2 = this;
    Object.keys(this.constructor.propTypes).forEach(function(t2) {
      e2.constructor.isComplexType(t2) && Object.defineProperty(e2, t2, { get: function() {
        return e2.props[t2];
      }, set: function(n4) {
        Object.is(n4, e2.props[t2]) || (e2.props[t2] = n4, e2.queuedUpdate());
      }, enumerable: true, configurable: true });
    });
  }, o3.isComplexType = function(e2) {
    if (!this.useDOMProperty) return false;
    var t2 = this.propTypes;
    return !(!t2[e2] || /^on|children/.test(e2)) && (h2(t2[e2]) ? t2[e2] : [t2[e2]]).some(function(e3) {
      return e3 === Object || e3 === Array || h2(e3) && e3.includes(Object);
    });
    ...
    this.props.ignoreAttrs || this.update();
    ...
    for (var e2 = this, t2 = this.parentNode; t2 && !this.store && !B.mixin.store; ) this.store = t2.store, t2 = t2.parentNode || t2.host;
    if (this.inject) {
      var n4;
    ...
    if (this.constructor.isLightDOM || Y.has(this.constructor)) this.renderRoot.adoptedStyleSheets = Y.get(this.constructor);
    else {
      ...
      if (e2) {
        ...
        }) : e2.default && "string" == typeof e2.default ? [m(e2.default)] : [e2], t2 = [].concat(B.globalCSS, t2), this.renderRoot.adoptedStyleSheets = t2, Y.set(this.constructor, t2);
      } else B.globalCSS.length && (this.renderRoot.adoptedStyleSheets = B.globalCSS);
    }
    ...
    this.appendStyleVNode(o4), this.rendered(o4), c(), this.rootElement = H(null, o4, null, this, false), h2(this.rootElement) ? this.rootElement.forEach(function(e2) {
      var t2;
    ...
    this.appendStyleVNode(r3), this.rendered(r3), c(null), this.rootElement = H(this.rootElement, r3, this.renderRoot, this, !!n4), this.updated(), this.fire("updated", this);
    ...
    if (!this.props.ignoreAttrs) {
      var t2 = this, n4 = this.constructor;
      t2.props.css = t2.getAttribute("css");
      var r3 = n4.propTypes;
      r3 && Object.keys(r3).forEach(function(r4) {
        if (!n4.isComplexType(r4)) {
          var o4 = t2.getAttribute(y(r4));
          t2.props[r4] = null !== o4 ? e2.getTypeValueOfProp(r4, o4) : n4.defaultProps && n4.defaultProps.hasOwnProperty(r4) ? n4.defaultProps[r4] : null;
        }
      });
    }
    ...
    this.props.children || (this.props.children = P.call(this, this.childNodes));
  }, u3.rendered = function(e2) {
  }, u3.receiveProps = function() {
  }, i3 = o3, c3 = [{ key: "observedAttributes", get: function() {
    var e2 = this;
    return Object.keys(this.props || {}).length > 0 ? Object.keys(this.props).map(y) : Object.keys(this.propTypes || {}).length > 0 ? Object.keys(this.propTypes).filter(function(t2) {
      return !/^on|children/.test(t2) && !e2.isComplexType(t2);
    }).map(y) : [];
...
ee.h = A, ee.f = A.f, ee.is = "Component", ee.defaultProps = void 0, ee.reflectProps = void 0, ee.propTypes = void 0, ee.css = void 0, ee.isLightDOM = void 0, ee.noSlot = void 0, ee.hooks = void 0, ee.props = {}, ee.useDOMProperty = true, ee.formAssociated = true;
var te = function(e2) {
  function t2() {
...
function ne(e2, t2, n3) {
  return t2 = "string" == typeof t2 ? document.querySelector(t2) : t2, n3 && t2 && (t2.store = n3), H(null, e2, t2, null, false);
}
te.formAssociated = false;
  ...
  for (var e2 = [].slice.call(arguments), t2 = [], n3 = 0; n3 < e2.length; n3++) {
    ...
    if (r3) {
      ...
      if ("string" === o3 || "number" === o3) t2.push(r3);
        ...
        var i3 = oe.apply(void 0, r3);
        i3 && t2.push(i3);
      } else if ("object" === o3) for (var s3 in r3) re.call(r3, s3) && r3[s3] && t2.push(s3);
    }
  }
  return t2.join(" ");
}
function ie(e2) {
  ...
  if (e2.class ? (t2.unshift(e2.class), delete e2.class) : e2.className && (t2.unshift(e2.className), delete e2.className), t2.length > 0) return { class: oe.apply(void 0, t2) };
}
var se = {};
function ae(e2) {
  ...
  return r3.replaceSync(n3), se[n3] = r3, r3;
}
var ce = "7.7.7";
export {
  ee as Component,
  te as FormAssociatedComponent,
  ee as WeElement,
  b as batch,
  S as bind,
  oe as classNames,
