...
<!-- <div class="box-default">
  ...
  <div>
    ...
    <y-button size="default" type="outline" @click="() => console.log('被你发现这里偷偷加了click事件了')"></y-button>
...
<ButtonVue ref="buttonRef"></ButtonVue>

::: details 查看代码

::: code-group

<<< @/../../play\vue-project\src\pages\Button\index.vue#button [vue]
